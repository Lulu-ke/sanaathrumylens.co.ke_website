...
// PATCH: Approve/Reject/Spam comment — MODERATOR+
...
export async function DELETE(
  ...
  try {
    ...
    // Author can delete own comment, moderator+ can delete any
    const isAuthor = existing.authorId === session.user.id;
    const canModerate = hasPermission(session.user.role, "MODERATOR");
