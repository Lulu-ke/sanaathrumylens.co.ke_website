...
const createUserSchema = z.object({
  ...
  role: z.enum(["ADMIN", "EDITOR", "AUTHOR", "MODERATOR", "READER"]),
  bio: z.string().optional(),
  image: z.string().optional(),
});

// GET: List users (paginated, filtered by role) — SUPER_ADMIN, ADMIN only
...
// POST: Create dashboard user — SUPER_ADMIN only
