...
export default function UsersPage() {
  ...
  const createUserMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setCreateForm({ name: "", email: "", username: "", password: "", role: "AUTHOR", bio: "" })
  ...
  const getRoleBadgeColor = (userRole: string) => {
    const colors: Record<string, string> = {
      ...
      AUTHOR: "bg-sky-100 text-sky-800 dark:bg-sky-900/30 dark:text-sky-400",
      MODERATOR: "bg-violet-100 text-violet-800 dark:bg-violet-900/30 dark:text-violet-400",
